...
var constants = {
  ...
  survay: {
    1: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["ゲームをしていないときにどれくらい頻繁（ひんぱん）に、ゲームのことを空想（くうそう）したり、以前にしたゲームのことを考えたり、次にするゲームのことを思ったりすることがありましたか。"],
    },

    2: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["ゲームが全くできなかったり、いつもよりゲーム時間が短かったとき、どれくらい頻繁（ひんぱん）にソワソワしたり、イライラしたり、不安になったり、悲しい気持ちになりましたか。"],
    },

    3: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["過去12ヵ月間で、十分ゲームをしたと感じるために、もっと頻繁に（ひんぱん）、またはもっと長い時間ゲームをする必要があると感じたことがありますか。 "],
    },

    4: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["過去12ヵ月間で、ゲームをする時間を減らそうとしたが、うまく行かなかったことがありますか。"],
    },

    5: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["過去12ヵ月間で、友人に会ったり、以前に楽しんでいた趣味（しゅみ）や遊びをすることよりも、 ゲームの方を選んだことがありますか。 "],
    },

    6: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["何らかの問題が生じているにもかかわらず、長時間ゲームをしたことがありますか。問 題とはたとえば、睡眠不足（すいみんぶそく）、学校での勉強や職場（しょくば）での仕事がはかどらない、家族や友 人と口論（こうろん）する、するべき大切なことをしなかった、などです。 "],
    },

    7: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["自分がどれくらいゲームをしていたかについて、家族、友人、または他の大切な人にば れないようにしようとしたり、ゲームについてそのような人たちに嘘（うそ）をついたことがありますか。"],
    },

    8: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["嫌な気持ちを晴らすためにゲームをしたことがありますか。嫌な気持ちとは、たとえ ば、無力（むりょく）に感じたり、罪（つみ）の意識（いしき）を感じたり、不安になったりすることです。 "],
    },

    9: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["ゲームのために大切な人間関係をあやうくしたり、失ったことがありますか。"],
    },

    10: {
      type: "3choices",
      title: "それぞれの質問が、過去12ヵ月間、どの程度、そしてどれくらい頻繁（ひんぱん）に、あなたに当てはまるか、「全くなかった、ときどきあった、よくあった」から選んでください。",
      list: ["過去12ヵ月間で、ゲームのために学校での勉強や職場での仕事がうまくできなかったことがありますか。"],
    },
